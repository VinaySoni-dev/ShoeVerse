    ...
    <div className="product-detail-wrapper" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div className="product-detail">
        ...
        <div className="detail-info">
          ...
          <h2 style={{ fontSize: '2.8rem', marginBottom: '10px',color: '#a1a1aa' }}>{product.name}</h2>

          <p className="detail-price" style={{ fontSize: '2.5rem', margin: '15px 0' }}>₹{product.price.toFixed(2)} <p style={{ fontSize: '1.0rem', margintop: '5px' }}>(excluding GST)</p></p>
